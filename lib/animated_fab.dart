...
class _AnimatedFabState extends State<AnimatedFab>
        ...
        builder: (BuildContext context, Widget child) {
          return new Stack(
            ...
            children: <Widget>[
              ...
              _buildOption(Icons.check_circle, 0.0, _onAddIconClick()),
              _buildOption(Icons.flash_on, -math.pi / 3, _onAddIconClick()),
              _buildOption(
                  Icons.access_time, -2 * math.pi / 3, _onAddIconClick()),
              _buildOption(Icons.error_outline, math.pi, _onAddIconClick()),
              _buildFabCore(),
            ],
          );
        },
  ...
  Widget _buildOption(IconData icon, double angle, function) {
